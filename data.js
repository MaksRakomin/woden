...
const PROJECTS = [
  ...
  { id: 'p2', clientIds: ['c1'],       managerIds: ['m1'],      templateId: 't-consumer',      name: 'Product Launch',       status: 'draft',     sections: 6,  updated: '1 day ago',  team: ['elena@meridian.co', 'david@meridian.co'],                          description: '', preprompt: '', logo: null },
